...
class InfoHeaderTypeTest {
  ...
  void GivenInfoHeaderType_GetSize_ReturnsCorrectValues() {
    ...
    assertEquals(
        BitmapConstants.BITMAPV2INFOHEADER_SIZE, InfoHeaderType.BITMAPV2INFOHEADER.getSize());
    assertEquals(
        BitmapConstants.BITMAPV3INFOHEADER_SIZE, InfoHeaderType.BITMAPV3INFOHEADER.getSize());
  ...
  void GivenInfoHeaderType_FromSizeWithValidSizes_ReturnsCorrectValues() {
    assertEquals(
        ...
        InfoHeaderType.fromSize(BitmapConstants.BITMAPCOREHEADER_SIZE));
    assertEquals(
        InfoHeaderType.BITMAPINFOHEADER,
        InfoHeaderType.fromSize(BitmapConstants.BITMAPINFOHEADER_SIZE));
    assertEquals(
        InfoHeaderType.BITMAPV2INFOHEADER,
        InfoHeaderType.fromSize(BitmapConstants.BITMAPV2INFOHEADER_SIZE));
    assertEquals(
        InfoHeaderType.BITMAPV3INFOHEADER,
        InfoHeaderType.fromSize(BitmapConstants.BITMAPV3INFOHEADER_SIZE));
    assertEquals(
        InfoHeaderType.BITMAPV4HEADER,
        InfoHeaderType.fromSize(BitmapConstants.BITMAPV4HEADER_SIZE));
    assertEquals(
        InfoHeaderType.BITMAPV5HEADER,
        InfoHeaderType.fromSize(BitmapConstants.BITMAPV5HEADER_SIZE));
  }
  ...
  void GivenInfoHeaderType_TestUniquenessOfSizes() {
    long distinctSizes =
        java.util.Arrays.stream(InfoHeaderType.values())
            .mapToInt(InfoHeaderType::getSize)
            .distinct()
            .count();

    assertEquals(
        InfoHeaderType.values().length,
        distinctSizes,
